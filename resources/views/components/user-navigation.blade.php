            ...
            <div class="hidden md:flex items-center gap-5">
                ...
                @auth
                    @if(!auth()->user()->hasRole('owner'))
                        ...
                        @if($btn)
                            <a href="{{ $btn->url }}" class="{{ $btn->color }} text-white px-6 py-2.5 rounded-xl font-bold text-sm shadow-sm hover:shadow hover:-translate-y-0.5 transition-all duration-200 active:scale-95">
                                {{ $btn->label }}
                            </a>
                        @endif
                    @endif
                ...
                @else
                    <div class="flex items-center gap-4 ml-2">
                        <a href="{{ route('login') }}" class="text-sm font-bold text-gray-600 hover:text-gray-900 transition px-2">
                            Log in
                        </a>

                        <a href="{{ route('register') }}" class="bg-gray-900 hover:bg-black text-white px-6 py-2.5 rounded-xl font-bold text-sm shadow-md transition-all duration-200 active:scale-95">
                            Sign up
                        </a>
                    </div>
                @endauth
