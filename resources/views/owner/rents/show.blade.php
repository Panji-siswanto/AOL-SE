            ...
            <div class="lg:col-span-1 sticky top-28 bg-white p-6 sm:p-8 rounded-[2rem] border border-gray-200 shadow-xl shadow-gray-100/50">
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <span class="text-sm font-black text-gray-900">
                            @if($rentRequest->pricing && $rentRequest->pricing->price > 0)
                                {{ floor($rentRequest->total_price / $rentRequest->pricing->price) }} unit(s)
                            @else
                                N/A
                            @endif
                        </span>
                ...
                @if($rentRequest->status_id == \App\Models\Status::RNT_REQ_PENDING)
                    <div class="space-y-3 pt-6 border-t border-gray-100">
                        <button @click.prevent="window.dispatchEvent(new CustomEvent('open-approve-modal'))" class="w-full bg-teal-600 hover:bg-teal-700 text-white py-3.5 rounded-2xl font-black transition-all active:scale-95 shadow-lg shadow-teal-600/30">
                            Accept Application
                        </button>
                        <button @click.prevent="window.dispatchEvent(new CustomEvent('open-reschedule-modal'))" class="w-full bg-blue-50 hover:bg-blue-100 text-blue-700 border border-blue-200 py-3.5 rounded-2xl font-black transition-all active:scale-95 shadow-sm">
